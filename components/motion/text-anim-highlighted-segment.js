...
export const HighlightedSegment = ({ segment, highlight }) => {
    ...
    const renderSegmentContent = (contentNodes) => {
      switch (highlight) {
        case 'underline':
          return (
            <span className="inline-flex relative py-0">
              <span className="z-10 px-3" style={style}>{contentNodes}</span>
            </span>
          );
        case 'background':
          return (
            <span className="inline-flex relative py-0">
              <span style={{ color: 'var(--text-accent)' }} className="z-10 px-3">{contentNodes}</span>
              <span 
          ...
          return (
            <span className="inline-flex relative py-0">
              <motion.span 
                ...
                style={style}
              />
              <span className="relative z-10 px-3" style={{ color: 'var(--text-accent)' }}>{contentNodes}</span>
            </span>
          );
        case 'figma':
          return (
            <span className="inline-flex relative py-0">
              <span className="z-10 px-3" style={{ color: 'var(--text-accent)' }}>{contentNodes}</span>
              <span 
    ...
    const contentWithItalics = hasItalic
    ...
    return renderSegmentContent(contentWithItalics);
};

...
/**
 * Toast Component
 * Displays a temporary notification message with different types
 * @component
 * @category notifications
 * @param {Object} props - Component props
 * @param {number} props.id - Unique toast identifier
 * @param {ToastType} props.type - Toast type (default, success, error, warning, info)
 ...
 * @param {number} props.timeout - Auto-dismiss timeout in ms (0 = no auto-dismiss)
 * @example
...
const Toast = ({
  ...
  return (
    <motion.div
      ...
      className={`flex items-start p-4 mb-3 rounded-lg border shadow-lg backdrop-blur-sm ${getColorClasses()}`}
      role="alert"
    >

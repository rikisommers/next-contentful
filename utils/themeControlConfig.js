...
export const themeControlConfig = {
  ...
  Globals: {
    ...
    gridPrimary: { type: "select", label: "Grid Primary", options: articleListLayoutThemes },
    gridSecondary: { type: "select", label: "Grid Secondary", options: articleListLayoutThemes },
    ...
    gridSecColumnsSm: { type: "select", label: "Sm", options: gridColumns },
    gridSecColumnsMd: { type: "select", label: "Md", options: gridColumns },
    gridSecColumnsLg: { type: "select", label: "Lg", options: gridColumns },
    gridSecColumnsXl: { type: "select", label: "Xl", options: gridColumns },

...
const ComponentPreview = () => {
  ...
  / */}
    ...
    <div className="category-section">
      ...
      <div className="component-section">
        <h3>ButtonMonks</h3>
        <p>Advanced button component with Monks-style animations and effects</p>
        <div className="examples">
        <div key="0" className="example-item">
          <h4>{example.title || `Example ${index + 1}`}</h4>
          <div className="example-preview">
  ...
  /> */}
        ...
        <div key="2" className="example-item">
          <h4>{example.title || `Example ${index + 1}`}</h4>
          <div className="example-preview">
            {/*   <ButtonMonks
  label="Activate"
  ...
  /> */}
        ...
        <div key="3" className="example-item">
          <h4>{example.title || `Example ${index + 1}`}</h4>
          <div className="example-preview">
            {/*   <ButtonMonks
  label="Close"
  ...
  /> */}
        ...
        <div key="4" className="example-item">
          <h4>{example.title || `Example ${index + 1}`}</h4>
          <div className="example-preview">
            {/*   <ButtonMonks
  type={ButtonType.PRIMARY}
  ...
  / */}
      ...
      <div className="component-section">
        <h3>ButtonSwap</h3>
        <p>Button component with text swap animation on hover</p>
        <div className="examples">
        <div key="0" className="example-item">
          <h4>{example.title || `Example ${index + 1}`}</h4>
          <div className="example-preview">
  ...
  / */}
      ...
      <div className="component-section">
        <h3>ButtonWipe</h3>
        <p>Button component with wipe animation effect on hover</p>
        <div className="examples">
        <div key="0" className="example-item">
          <h4>{example.title || `Example ${index + 1}`}</h4>
          <div className="example-preview">
  ...
  / */}
      ...
      <div className="component-section">
        <h3>Button</h3>
        <p>Basic button component with customizable styling and sound effects</p>
        <div className="examples">
        <div key="0" className="example-item">
          <h4>{example.title || `Example ${index + 1}`}</h4>
          <div className="example-preview">
